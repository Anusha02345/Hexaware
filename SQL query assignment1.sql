...
use shop;
create table customer_master(CUSTOMER_NUMBER varchar(20) primary key,FIRSTNAME varchar(50),middlename varchar(50),lastname varchar(50),CUSTOMER_CITY varchar(30),CUSTOMER_CONTACT_NO bigint,
...
select occupation,COUNT(*) from customer_master 
GROUP BY occupation
